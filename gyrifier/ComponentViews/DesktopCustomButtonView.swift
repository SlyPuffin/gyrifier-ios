...
extension DesktopCustomButtonView {
...
struct DesktopCustomButtonView: View {
    let label: String
...
struct DesktopCustomButtonView_Previews: PreviewProvider {
    static var previews: some View {
        GeometryReader { geo in
            DesktopCustomButtonView("Custom Button", buttonSize: .large, screenSize: geo.size, buttonStyle: .cancel)
        }
    }
}
